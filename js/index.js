  ...
  if (username === manager.Username) {
    if (manager.Password !== password) {
      ...
      document.getElementById("login-evaluation").innerHTML =
        "<p class='text-danger small'>Password not correct for manager!</p>";
      return;
    }
    ...
    if (user) {
      if (user.Password !== password) {
        console.log("Password not correct");
        document.getElementById("login-evaluation").innerHTML =
          "<p class='text-danger small'>Password not correct!</p>";
        return;
      }
      ...
      document.getElementById("login-evaluation").innerHTML =
        "<p class='text-danger small'>User does not exist!</p>";
    }
  }
}
